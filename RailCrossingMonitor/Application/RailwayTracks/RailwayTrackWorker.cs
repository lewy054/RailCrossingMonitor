...
public sealed class RailwayTrackWorker(
    ...
    ILogger<RailwayTrackWorker> logger)
    : BackgroundService
{
        ...
        CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            {
                var httpClient =
                    httpClientFactory.CreateClient("RailwayTracks");
            ...
            catch (Exception ex)
            {
                logger.LogError(
                    ex,
                    "Failed to load railway tracks. " +
                    "Retrying in {RetryMinutes} minutes.",
